...
export default function Sidebar({ 
  ...
  return (
    <aside className="w-16 md:w-64 shrink-0 border-r flex flex-col justify-between h-screen sticky top-0 bg-card transition-colors duration-300 border-border overflow-hidden">
      ...
      {/* Footer Controls */}
      <div className="p-2 md:p-4 border-t border-border space-y-2 md:space-y-3 shrink-0">
        {/* Theme Toggle Button */}
        <button
          onClick={() => setDarkMode(!darkMode)}
          className="w-full flex items-center justify-center md:justify-between p-2 rounded-xl border border-border bg-muted/30 hover:bg-muted text-muted-foreground hover:text-foreground transition-all cursor-pointer"
        ...
        {/* User Auth Controls */}
        {user ? (
          <div className="flex items-center justify-center md:justify-between pt-1">
